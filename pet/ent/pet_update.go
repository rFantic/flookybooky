...
func (pu *PetUpdate) SetSpecies(s string) *PetUpdate {
	pu.mutation.SetSpecies(s)
	return pu
}
...
// SetSpecies sets the "species" field.
func (puo *PetUpdateOne) SetSpecies(s string) *PetUpdateOne {
	puo.mutation.SetSpecies(s)
	return puo
}
