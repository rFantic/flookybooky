...
func Address(v string) predicate.Airport {
	return predicate.Airport(sql.FieldEQ(FieldAddress, v))
}
...
func AddressEQ(v string) predicate.Airport {
	return predicate.Airport(sql.FieldEQ(FieldAddress, v))
}

// AddressNEQ applies the NEQ predicate on the "address" field.
func AddressNEQ(v string) predicate.Airport {
	return predicate.Airport(sql.FieldNEQ(FieldAddress, v))
}

// AddressIn applies the In predicate on the "address" field.
func AddressIn(vs ...string) predicate.Airport {
	return predicate.Airport(sql.FieldIn(FieldAddress, vs...))
}

// AddressNotIn applies the NotIn predicate on the "address" field.
func AddressNotIn(vs ...string) predicate.Airport {
	return predicate.Airport(sql.FieldNotIn(FieldAddress, vs...))
}

// AddressGT applies the GT predicate on the "address" field.
func AddressGT(v string) predicate.Airport {
	return predicate.Airport(sql.FieldGT(FieldAddress, v))
}

// AddressGTE applies the GTE predicate on the "address" field.
func AddressGTE(v string) predicate.Airport {
	return predicate.Airport(sql.FieldGTE(FieldAddress, v))
}

// AddressLT applies the LT predicate on the "address" field.
func AddressLT(v string) predicate.Airport {
	return predicate.Airport(sql.FieldLT(FieldAddress, v))
}

// AddressLTE applies the LTE predicate on the "address" field.
func AddressLTE(v string) predicate.Airport {
	return predicate.Airport(sql.FieldLTE(FieldAddress, v))
}

// AddressContains applies the Contains predicate on the "address" field.
func AddressContains(v string) predicate.Airport {
	return predicate.Airport(sql.FieldContains(FieldAddress, v))
}

// AddressHasPrefix applies the HasPrefix predicate on the "address" field.
func AddressHasPrefix(v string) predicate.Airport {
	return predicate.Airport(sql.FieldHasPrefix(FieldAddress, v))
}

// AddressHasSuffix applies the HasSuffix predicate on the "address" field.
func AddressHasSuffix(v string) predicate.Airport {
	return predicate.Airport(sql.FieldHasSuffix(FieldAddress, v))
}

// AddressEqualFold applies the EqualFold predicate on the "address" field.
func AddressEqualFold(v string) predicate.Airport {
	return predicate.Airport(sql.FieldEqualFold(FieldAddress, v))
}

// AddressContainsFold applies the ContainsFold predicate on the "address" field.
func AddressContainsFold(v string) predicate.Airport {
	return predicate.Airport(sql.FieldContainsFold(FieldAddress, v))
}

// HasOrigin applies the HasEdge predicate on the "origin" edge.
func HasOrigin() predicate.Airport {
...
func HasOriginWith(preds ...predicate.Flight) predicate.Airport {
	return predicate.Airport(func(s *sql.Selector) {
		step := newOriginStep()
...
func HasDestination() predicate.Airport {
	return predicate.Airport(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasDestinationWith(preds ...predicate.Flight) predicate.Airport {
	return predicate.Airport(func(s *sql.Selector) {
